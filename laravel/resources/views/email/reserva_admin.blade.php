...
<p style="color:#000000; font-size:22px;">Se ha registrado una nueva reserva</p>{{ $company->name }}
@if (isset ($datos['dia']) )
<p style="color:#878787; font-size:16px;"><strong>Lugar:</strong> {{ $company->name }}</p>
<p style="color:#878787; font-size:16px;"><strong>A nombre de:</strong> {{  $datos['name'] }}</p>

...
<p style="color:#000000; font-size:22px;">Hola! tienes una reserva programada</p>
<p style="color:#878787; font-size:16px;">Hola {{ $datos['name'] }}, Bienvenido(a) a nuestra familia  tu correo es {{ $datos['correo'] }}.</p>
@if (isset ($datos['dia']) )
<p style="color:#878787; font-size:16px;"><strong>Lugar:</strong> {{ $company->name }}</p>

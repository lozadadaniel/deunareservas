...
<tr><td><img src="{{ asset('email/images/banner.jpg') }}" style="display:block;" border="0"/></td></tr>
<tr><td height="155" align="center" style="font-family:Arial, Helvetica, sans-serif; text-align:center;">
<p style="color:#000000; font-size:22px;">Nuevo usuario Registrado</p>
<p style="color:#878787; font-size:16px;"><strong>Nombre:</strong> {{ $name }}</p>
<p style="color:#878787; font-size:16px;"><strong>Correo:</strong> {{ $email }}</p>
<p style="color:#878787; font-size:16px;"><strong>Telefono:</strong> {{ $phone }}</p>
